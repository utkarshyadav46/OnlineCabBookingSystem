...
<body>
	<h1>TAXIWALE.com(DRIVER PORTAL ACCOUNT) </h1>
				...
				<div class="facts">
					<div class="register">
						<form action="dlogin.php" method="post">										
							<input placeholder="Email Address" class="mail" name="email" type="text"  required="">									
							<input placeholder="Password" class="lock" name="pass" type="password" required="">										
							<div class="sign-up">
